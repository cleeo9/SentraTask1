...
public class LogInSteps {
    ...
    public void se_muestra_mensaje() {
        Assert.assertTrue(landingPage.isLoginSuccessful(), "Usuario no logueado correctamente");
    }

    @Then("No logro ingresar a la plataforma")
    public void se_muestra_mensaje_error() {
        Assert.assertTrue(landingPage.isLoginFailed(), "Usuario logueado correctamente");
    }
}