...
perfil actualizado.
  ...
  Background: Se hace Login a la página
    ...
    When Ingreso el email "pruebaregister16@gmail.com" y contraseña "123456"
  ...
  Scenario: Modificar datos del perfil de usuario
    ...
    And Ingreso nuevo nombre "Juanito", nuevo apellido "Perez" y nuevo email "pruebaregister16@gmail.com"
    And Hago click en el botón modificar usuario
    Then Los datos del usuario nombre "Juanito", apellido "Perez" y el email "pruebaregister16@gmail.com" se modifican correctamente
